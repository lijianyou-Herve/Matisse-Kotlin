package com.herve.library.matisse.engine
...
interface ImageEngine {
     ...
     */
    abstract fun loadThumbnail(context: Context, resize: Int, placeholder: Drawable, imageView: ImageView, uri: Uri)
     ...
     * @param uri         Uri of the loaded image
     */
    abstract fun loadGifThumbnail(context: Context, resize: Int, placeholder: Drawable, imageView: ImageView, uri: Uri)
     ...
     * @param uri       Uri of the loaded image
     */
    abstract fun loadImage(context: Context, resizeX: Int, resizeY: Int, imageView: ImageView, uri: Uri)
     ...
     * @param uri       Uri of the loaded image
     */
    abstract fun loadGifImage(context: Context, resizeX: Int, resizeY: Int, imageView: ImageView, uri: Uri)
     ...
     */
    abstract fun supportAnimatedGif(): Boolean
}